const colorButtons = document.querySelectorAll(".Achilles_colorButton");
const mainVisual = document.querySelector(".Achilles_mainVisual");
const slides = document.querySelectorAll(".Achilles_slide");
const arrows = document.querySelectorAll(".Achilles_arrow");
const sliderTrack = document.querySelector(".Achilles_sliderTrack");
const productNameEl = document.querySelector(".Achilles_productName");
let currentSlide = 0;
...
function showSlide(index) {
  ...
  const names = [
    "Osaki 4D Achilles",
    "Osaki 4D Achilles Black",
    "Osaki 4D Achilles Brown",
    "Osaki 4D Achilles Taupe",
  ];
