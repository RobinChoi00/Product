const colorButtons = document.querySelectorAll(".Somnus_colorButton");
const mainVisual = document.querySelector(".Somnus_mainVisual");
const slides = document.querySelectorAll(".Somnus_slide");
const arrows = document.querySelectorAll(".Somnus_arrow");
const sliderTrack = document.querySelector(".Somnus_sliderTrack");
const productNameEl = document.querySelector(".Somnus_productName");
let currentSlide = 0;
...
function showSlide(index) {
  ...
  const names = [
    "Osaki Somnus 4D Duoflex AI",
    "Osaki Somnus 4D Duoflex AI Black",
    "Osaki Somnus 4D Duoflex AI Brown",
  ];
