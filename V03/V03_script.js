const colorButtons = document.querySelectorAll(".V03_colorButton");
const mainVisual = document.querySelector(".V03_mainVisual");
const slides = document.querySelectorAll(".V03_slide");
const arrows = document.querySelectorAll(".V03_arrow");
const sliderTrack = document.querySelector(".V03_sliderTrack");
const productNameEl = document.querySelector(".V03_productName");
let currentSlide = 0;
