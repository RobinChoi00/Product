const colorButtons = document.querySelectorAll(".ReIntegra_colorButton");
const mainVisual = document.querySelector(".ReIntegra_mainVisual");
const slides = document.querySelectorAll(".ReIntegra_slide");
const arrows = document.querySelectorAll(".ReIntegra_arrow");
const sliderTrack = document.querySelector(".ReIntegra_sliderTrack");
const productNameEl = document.querySelector(".ReIntegra_productName");
let currentSlide = 0;
...
function showSlide(index) {
  ...
  const names = [
    "Amamedic 3D Integra",
    "Amamedic 3D Integra Black",
    "Amamedic 3D Integra Brown",
    "Amamedic 3D Integra Taupe",
  ];
