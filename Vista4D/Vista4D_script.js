const colorButtons = document.querySelectorAll(".Vista_colorButton");
const mainVisual = document.querySelector(".Vista_mainVisual");
const slides = document.querySelectorAll(".Vista_slide");
const arrows = document.querySelectorAll(".Vista_arrow");
const sliderTrack = document.querySelector(".Vista_sliderTrack");
const productNameEl = document.querySelector(".Vista_productName");
let currentSlide = 0;
...
function showSlide(index) {
  ...
  const names = [
    "Osaki Vista 4D",
    "Osaki Vista 4D Black",
    "Osaki Vista 4D Brown",
  ];
