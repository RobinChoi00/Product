const colorButtons = document.querySelectorAll(".ReLuxe_colorButton");
const mainVisual = document.querySelector(".ReLuxe_mainVisual");
const slides = document.querySelectorAll(".ReLuxe_slide");
const arrows = document.querySelectorAll(".ReLuxe_arrow");
const sliderTrack = document.querySelector(".ReLuxe_sliderTrack");
const productNameEl = document.querySelector(".ReLuxe_productName");
let currentSlide = 0;
