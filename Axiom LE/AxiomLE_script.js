const colorButtons = document.querySelectorAll(".Axiom_colorButton");
const mainVisual = document.querySelector(".Axiom_mainVisual");
const slides = document.querySelectorAll(".Axiom_slide");
const arrows = document.querySelectorAll(".Axiom_arrow");
const sliderTrack = document.querySelector(".Axiom_sliderTrack");
const productNameEl = document.querySelector(".Axiom_productName");
let currentSlide = 0;
...
function showSlide(index) {
  ...
  const names = [
    "Titan Axiom LE",
    "Titan Axiom LE Black",
    "Titan Axiom LE Brown",
    "Titan Axiom LE Taupe",
  ];
