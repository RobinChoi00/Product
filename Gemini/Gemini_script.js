const colorButtons = document.querySelectorAll(".Gemini_colorButton");
const mainVisual = document.querySelector(".Gemini_mainVisual");
const slides = document.querySelectorAll(".Gemini_slide");
const arrows = document.querySelectorAll(".Gemini_arrow");
const sliderTrack = document.querySelector(".Gemini_sliderTrack");
const productNameEl = document.querySelector(".Gemini_productName");
let currentSlide = 0;
